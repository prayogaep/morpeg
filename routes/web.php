...
Route::group(['middleware'], function () {
    ...
    // Kelola_monitoring
    Route::get('/kelolamonitoring', [KelolaMonitoringController::class, 'index'])->name('kelolamonitoring.index');
    Route::get('/kelolamonitoring/create', [KelolaMonitoringController::class, 'create'])->name('kelolamonitoring.create');
    ...
    Route::get('/kelolapegawai/tambah_data', [KelolaPegawaiController::class, 'tambah_data'])->name('kelolapegawai.tambah_data');
    Route::post('/kelolapegawai/simpan_data', [KelolaPegawaiController::class, 'store'])->name('kelolapegawai.simpan_data');
    Route::get('/kelolapegawai/edit_data/{id}', [KelolaPegawaiController::class, 'edit_data'])->name('kelolapegawai.edit_data');
    Route::post('/kelolapegawai/update_data/{id}', [KelolaPegawaiController::class, 'update_data'])->name('kelolapegawai.update_data');
    Route::get('/kelolapegawai/delete_data/{id}', [KelolaPegawaiController::class, 'delete_data'])->name('kelolapegawai.delete_data');
