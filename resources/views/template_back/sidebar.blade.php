...
<aside class="main-sidebar app-sidebar sidebar-scroll">
        ...
        <div class="app-sidebar__user">
            <div class="dropdown user-pro-body text-center">
                ...
                <div class="user-info">
                    ...
                    <span class="text-muted app-sidebar__user-name text-sm">{{ auth()->user()->isrole }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="main-sidebar-body">
        <ul class="side-menu ">
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard') }}"><i class="side-menu__icon fe fe-home"></i><span
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->is('penilaianpegawai*') ? 'active' : '' }}"
                        href="{{ route('penilaianpegawai.index') }}"><i class="side-menu__icon fe fe-user"></i><span
                            class="side-menu__label">Penilaian Pegawai</span></a>
                </li>
            @endif
