                    ...
                    <div class="main-signin-header">
                        ...
                        <form action="{{route('auth')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input class="form-control rounded @error('username') is-invalid @enderror" id="username" placeholder="Masukkan username anda" type="username" name="username" autofocus required>
                            </div>
                            <div class="form-group">
                                ...
                                @enderror
                                <input class="form-control rounded" id="password" placeholder="Masukkan password anda" type="password" name="password" required>
                            </div>
                            <button class="btn btn-main-primary btn-block" type="submit">Login <i class="fas fa-sign-in-alt"></i></button>
                        </form>
                    </div>
                    {{-- <div class="text-center main-signin-footer mt-3 mg-t-5">
                        <p>Belum registrasi? <a href="{{ route('indexregister') }}">Registrasi</a></p>
                    </div> --}}
                </div>
            </div>
        </div>
